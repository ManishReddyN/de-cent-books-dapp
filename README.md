# NOTE: THIS BRANCH IS CURRENTLY UNDER DEVELOPMENT AND PARTIALLY FULFILLS THE REQUIREMENTS. IT IS NOT ADVISED TO INTEGRATE IT WITH THE FRONT-END BUT IT CAN BE RUN LOCALLY ON YOUR MACHINE. 
